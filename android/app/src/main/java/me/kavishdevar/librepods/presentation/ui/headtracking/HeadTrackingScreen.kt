...
package me.kavishdevar.librepods.presentation.ui.headtracking
...
fun HeadTrackingScreen(
    ...
    LiquidScaffold(
        topBar = {
            LiquidTopAppBar(
                title = {
                    Text(stringResource(R.string.head_tracking))
                },
                navigationIcon = {
                    LiquidIconButton(
    ...
    Card(
        ...
        Box(
            ...
            Canvas(
                ...
                drawLine(
                    color = if (darkTheme) Color.White.copy(alpha = 0.3f) else Color.Black.copy(
                        alpha = 0.3f
                    ),
