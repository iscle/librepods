package me.kavishdevar.librepods.presentation.ui.version
...
//            Spacer(Modifier.height(spacerHeight))
            ...
            Surface(
                ...
                Column {
                    VersionRow(
                        label = "${stringResource(R.string.version)} 1",
                        value = state.version1
                    )
                    HorizontalDivider(color = colorScheme.outline, thickness = 0.33.dp)
                    VersionRow(
                        label = "${stringResource(R.string.version)} 2",
                        value = state.version2
                    )
                    HorizontalDivider(color = colorScheme.outline, thickness = 0.33.dp)
                    VersionRow(
                        label = "${stringResource(R.string.version)} 3",
